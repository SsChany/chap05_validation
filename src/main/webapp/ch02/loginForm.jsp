...
<title>Insert title here</title>
   <script>
      /*
         ...
         - event는 event가 발생한 엘리먼트에 대한 정보를 담고 있는 이벤트
           객체이다.
      */
      function checkForm(event) {
         ...
         // 보내려고 한다. 그 행동을 차단하는 기능을 해준다.
            ...
            // 정규 표현식 사용(숫자와 영문자)
            var idRegax = /^[A-Za-z0-9]+$/;
            // 아이디를 정규표현식에 넣어서 테스트해서 거짓일경우
            if (!idRegax.test(id)) {
            ...
            // 비밀번호는 적어도 한 개 이상의 특수문자가 들어가도록 정규 표현식 사용
            var passwordRegax = /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/;
...
<body>
   <form id="loginForm" action="${pageContext.request.contextPath}
                        /ch01/loginProcessing.jsp"
                        method="post">
      <div>
